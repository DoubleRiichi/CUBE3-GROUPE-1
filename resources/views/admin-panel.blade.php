            ...
            <div class="col col-md-10 table-responsive m-auto">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        @else
                        <tr>
                            <th scope="row" colspan="3">Aucune action de modération réalisé !</th>
                        </tr>
                        @endif
                    </tbody>
                    <tfoot>
            ...
            <div class="col col-md-10 table-responsive m-auto">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    ?>
                        ...
                        @else
                        <tr>
                            <th scope="row" colspan="5">Pas de commentaires...</th>
                        </tr>
                        @endif
                    </tbody>
                    <tfoot>
            ...
            <div class="col col-md-10 table-responsive m-auto">
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="/admin/unban" method="post">
                                    ...
                                    <button class="bluebtn" type="submit">déban</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
                        @else
                        <tr>
                            <th scope="row" colspan="5">Aucun utilisateur banni!</th>
                        </tr>
                        @endif
                    </tbody>
                    <tfoot>
